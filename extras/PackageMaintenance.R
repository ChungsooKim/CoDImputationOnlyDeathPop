...
OhdsiRTools::checkUsagePackage("CoDImputationOnlyDeathPop")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CoDImputationOnlyDeathPop.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CoDImputationOnlyDeathPop.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CoDImputationOnlyDeathPop")
